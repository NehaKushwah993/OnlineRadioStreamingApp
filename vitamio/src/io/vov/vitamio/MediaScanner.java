...
public class MediaScanner {
  ...
  public void scanDirectories(String[] directories) {
    try {
      ...
      Lg.d(" prescan time: %dms", prescan - start);
      Lg.d("    scan time: %dms", scan - prescan);
      Lg.d("postscan time: %dms", end - scan);
      Lg.d("   total time: %dms", end - start);
    } catch (SQLException e) {
      Lg.e("SQLException in MediaScanner.scan()", e);
    } catch (UnsupportedOperationException e) {
      Lg.e("UnsupportedOperationException in MediaScanner.scan()", e);
    } catch (RemoteException e) {
      Lg.e("RemoteException in MediaScanner.scan()", e);
    }
  }
  ...
  public Uri scanSingleFile(String path, String mimeType) {
    try {
      ...
      Lg.e("RemoteException in MediaScanner.scanFile()", e);
      return null;
    }
  }
