...
public class EGL {
  ...
  public GL createSurface(Surface surface) {
    ...
    if (mEglSurface == null || mEglSurface == EGL10.EGL_NO_SURFACE) {
      ...
      if (error == EGL10.EGL_BAD_NATIVE_WINDOW) {
        Lg.e("EglHelper", "createWindowSurface returned EGL_BAD_NATIVE_WINDOW.");
        return null;
      }
    ...
    if (!mEgl.eglSwapBuffers(mEglDisplay, mEglSurface)) {
      ...
      switch (error) {
        ...
        case EGL10.EGL_BAD_NATIVE_WINDOW:
          Lg.e("EglHelper", "eglSwapBuffers returned EGL_BAD_NATIVE_WINDOW. tid=" + Thread.currentThread().getId());
          break;
        case EGL10.EGL_BAD_SURFACE:
          Lg.e("EglHelper", "eglSwapBuffers returned EGL_BAD_SURFACE. tid=" + Thread.currentThread().getId());
          return false;
        default:
  ...
  private void throwEglException(String function, int error) {
    ...
    Lg.e("EglHelper", "throwEglException tid=" + Thread.currentThread().getId() + " " + message);
  ...
  private class EGLContextFactory {
    ...
    public void destroyContext(EGL10 egl, EGLDisplay display, EGLContext context) {
      if (!egl.eglDestroyContext(display, context)) {
        Lg.e("DefaultContextFactory", "display:" + display + " context: " + context);
