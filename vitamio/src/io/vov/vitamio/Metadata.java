...
import io.vov.vitamio.utils.BuildConfig;
...
public class Metadata {
  ...
  public boolean parse(Map<byte[], byte[]> meta, String encoding) {
    ...
    if (BuildConfig.DEBUG) {
      Lg.i("Vitamio[Metadata]", "title:\t\t" + getString(TITLE));
      Lg.i("Vitamio[Metadata]", "comment:\t\t" + getString(COMMENT));
      Lg.i("Vitamio[Metadata]", "copyright:\t\t" + getString(COPYRIGHT));
      Lg.i("Vitamio[Metadata]", "album:\t\t" + getString(ALBUM));
      Lg.i("Vitamio[Metadata]", "artist:\t\t" + getString(ARTIST));
      Lg.i("Vitamio[Metadata]", "composer:\t\t" + getString(COMPOSER));
      Lg.i("Vitamio[Metadata]", "genre:\t\t" + getString(GENRE));
      Lg.i("Vitamio[Metadata]", "date:\t\t" + getString(DATE));
      Lg.i("Vitamio[Metadata]", "duration:\t\t" + getLong(DURATION));
      Lg.i("Vitamio[Metadata]", "length:\t\t" + getLong(LENGTH));
      Lg.i("Vitamio[Metadata]", "bit_rate:\t\t" + getInt(BIT_RATE));
      Lg.i("Vitamio[Metadata]", "audio_bit_rate:\t" + getInt(AUDIO_BIT_RATE));
      Lg.i("Vitamio[Metadata]", "video_bit_rate:\t" + getInt(VIDEO_BIT_RATE));
      Lg.i("Vitamio[Metadata]", "audio_sample_rate:\t" + getInt(AUDIO_SAMPLE_RATE));
      Lg.i("Vitamio[Metadata]", "video_frame_rate:\t" + getDouble(VIDEO_FRAME_RATE));
      Lg.i("Vitamio[Metadata]", "format:\t\t" + getString(MIME_TYPE));
      Lg.i("Vitamio[Metadata]", "audio_codec:\t" + getString(AUDIO_CODEC));
      Lg.i("Vitamio[Metadata]", "video_codec:\t" + getString(VIDEO_CODEC));
      Lg.i("Vitamio[Metadata]", "video_height:\t" + getInt(VIDEO_HEIGHT));
      Lg.i("Vitamio[Metadata]", "video_width:\t" + getInt(VIDEO_WIDTH));
      Lg.i("Vitamio[Metadata]", "num_tracks:\t\t" + getInt(NUM_TRACKS));
      Lg.i("Vitamio[Metadata]", "cap_pause:\t\t" + getBoolean(PAUSE_AVAILABLE));
      Lg.i("Vitamio[Metadata]", "cap_seek:\t\t" + getBoolean(SEEK_AVAILABLE));
    }
